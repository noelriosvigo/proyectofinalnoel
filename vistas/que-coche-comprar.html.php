  ...
  <div class="row">
    ...
    <main class="col-md-9 ps-md-4">
		...
		<div class="card mb-4 shadow-sm">
			<div class="card-header bg-primary text-white">
				<h4 class="text-white my-2">Últimas noticias sobre que coche comprar</h4>
			</div>
			<div class="card-body">
				<ul class="list-group list-group-flush">
					<?php
					$rss_url = 'https://es.motor1.com/rss/category/que-coche-comprar/';

...
<div class="container py-5">
  <div class="row">
		...
		<div class="card">
			<div class="card-body">
				<div class="list-group mb-4">
					...
					<a href="que-coche-comprar.php" class="list-group-item list-group-item-action">¿Qué coche comprar?</a>
				...
				<div class="mb-4">
					...
					<ul class="list-unstyled ps-4">
						...
						<li><a href="feed-RSS.php#f1" class="text-decoration-none"><i class="fas fa-flag-checkered me-2 text-danger"></i>Últimas noticias Fórmula 1</a></li>
						<li><a href="feed-RSS.php#motogp" class="text-decoration-none"><i class="fas fa-motorcycle me-2 text-primary"></i>Últimas noticias MotoGP</a></li>
					</ul>
				</div>				
				<hr>
				<div class="mb-4">
					...
					<ul class="list-unstyled ps-4">
					  <li class="mb-2">
						<a href="https://eventosmotor.com/" class="text-decoration-none">
						  <i class="fas fa-calendar-alt me-2 text-primary"></i>Eventos Próximos
						</a>
					  </li>
					</ul>
				</div>				
				<div class="card">
					<div class="card-header bg-primary text-white">
						<i class="fas fa-envelope-open-text me-2"></i>Suscríbete a nuestro boletín
					</div>
				<div class="card-body">
	...
	<!-- Se utiliza para extraer noticias desde un feed RSS de Motorsport.com y las muestra en tu web noticias actualizadas sin escribirlas manualmente. -->
    <main class="col-md-9 ps-md-4">
		<div class="text-center mb-5">
			<h1 class="text-primary fw-bold"><?php echo $titulo; ?></h1>
			<h4 class="text-secondary mb-2">Noticias recientes sobre motor</h5>
			<p class="text-muted">Fórmula 1, MotoGP y enlaces relacionados</p>
		</div>
		<div class="card mb-4 shadow-sm">
			<div class="card-header bg-primary text-white">
				<h4 id="motor" class="text-white my-2">Últimas noticias sobre el mundo del motor</h4>
			</div>
			<div class="card-body">  
				<ul class="list-group list-group-flush">
					<?php
					$rss_url = 'https://es.motor1.com/rss/news/all/';
					...
					if ($rss) {
						...
						echo '<li class="list-group-item text-danger fw-bold">⚠️ No se pudo cargar el feed RSS.</li>';
					}
					?>
				</ul>
			</div>
		...
		<div class="card mb-4 shadow-sm">
			<div class="card-header bg-primary text-white">
				<h4 id="f1" class="text-white my-2">🏎️ Últimas noticias sobre Fórmula 1</h4>
			</div>
			<div class="card-body">
				<ul class="list-group list-group-flush">
					<?php
		...
		<div class="card mb-4 shadow-sm">
			<div class="card-header bg-primary text-white">
				<h4 id="motogp" class="text-white my-2">🏍️ Últimas noticias sobre MotoGP</h4>
			</div>
			<div class="card-body">
				<ul class="list-group list-group-flush">
					<?php

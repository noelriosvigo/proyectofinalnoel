...
<head>
	...
	<title><?php echo isset($titulo) ? $titulo : 'Registro'; ?></title>
...
<body>
  <main class="form-signin">
    <div class="d-flex justify-content-center mb-2">
      <img src="imagenes/login/registrarse.png" style="max-width: 250px" alt="Registrarse" class="img-fluid mx-auto d-block">
    </div>
    ...
    <form method="post" action="registro.php" enctype="multipart/form-data" novalidate>
      ...
      <div class="form-floating mb-3">
        <input id="email" name="email" type="email" class="form-control" placeholder="Correo electrónico" required autocomplete="off">
      ...
      <div class="form-floating mb-3 position-relative">
        ...
        <button type="button" class="toggle-button" data-target="password" aria-label="Mostrar/Ocultar contraseña"></button>
      </div>
      ...
      <div class="form-floating mb-3 position-relative">
        ...
        <button type="button" class="toggle-button" data-target="confirm_password" aria-label="Mostrar/Ocultar contraseña"></button>
      </div>
      ...
      <div class="d-flex justify-content-center mt-3">
        <div style="border: 1px solid #ccc; padding: 6px 12px; border-radius: 6px; background-color: #f8f9fa; max-width: 220px; text-align: center;">
